  ...
  useEffect(() => {
    ...
    const checkAuthStatus = async () => {
      try {
        ...
        // If response is not ok, user is not authenticated, stay on login page
      } catch (error) {
      ...
      { assistant_id: trimmedAssistantId, password },
      {
        ...
        onError: (err) => {
          if (err.response?.data?.error === 'user_not_found') {
            ...
            setMessage("Sorry, this account is deactivated. Please contact Mr. Ahmed Badr (admin) or Tony Joseph (developer).");
          } else {
            setMessage("Wrong username and password");
          }
        }
