...
export default function AllStudents() {
  ...
  useEffect(() => {
    filterStudents();
  }, [students, selectedGrade, selectedCenter, selectedCourseType, searchTerm]);
  ...
  const filterStudents = () => {
    ...
    if (selectedCourseType) filtered = filtered.filter(student => 
      student.courseType && student.courseType.toLowerCase() === selectedCourseType.toLowerCase()
    );
    if (searchTerm.trim() !== "") {
